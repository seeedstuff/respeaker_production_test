...
void MT7688_run_test_task(void)
{
  ...
  Serial1.println("python /Media/SD-P1/microphone_test/main.py &");
}
...
void LEDActinID_Blink(void)
{
  LEDstripBlink(LED_NUM, rgb_led_state.color, 0xfff);
}
  ...
  switch(main_task_id) {
    ...
    case main_task_check_is_sdcard_installed:
      ...
      if (1 == ret) {
        ...
        rgb_led_state.number = 12;
        rgb_led_state.speed = 1000;
    ...
    case main_task_end:
      respeaker._loop();
      loop_event_1(LEDActinID_Blink, rgb_led_state.speed);
      break;
